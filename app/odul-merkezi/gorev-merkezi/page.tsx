            ...
            <div className="bg-background-main">
                ...
                <div className="container">
                    <div className="mb-6 flex items-center justify-between   py-5 ">
                        ...
                        <ButtonLink href="/odul-merkezi/market" variant="primary"  size="sm" className=""><span className="hidden md:block">Markete git</span>  <HugeiconsIcon className="md:hidden" icon={ArrowRight01Icon} /></ButtonLink>
                    </div>
                </div>
