...
/**
 * Son oynadıklarım: ana sayfadaki popüler slot görselleri; katalogda oyun adı eşleşenler
 * `/casino/{id}` ile, diğerleri `href` (slot) ile gider.
 */
export function getSonOynadiklarimGames(excludeGameId: string): CasinoLobbyGame[] {
