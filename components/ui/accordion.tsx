...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="m-0 flex text-inherit font-inherit">
      ...
      >
        ...
        <HugeiconsIcon
          ...
          className="pointer-events-none shrink-0 rotate-0 transition-transform duration-200 ease-out group-aria-expanded/accordion-trigger:-rotate-180"
        />
      </AccordionPrimitive.Trigger>
